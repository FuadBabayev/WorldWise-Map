...
/* eslint-disable*/
function CitiesReducer({ children }) {
  ...
  useEffect(function () {
    async function fetchCities() {
      ...
      try {
        ...
        dispatch({ type : 'rejected', payload : "There was an error loading cities ..." /* error.message */});
      }
    }
    fetchCities();
  }, []);
...
export { CitiesReducer, /* CitiesContext */ useCities };
